...
public class LessonController {
    ...
    public ResponseEntity<Object> saveLesson(@PathVariable(value = "moduleId") UUID moduleId,
        ...
        Optional<ModuleModel> moduleModelOptional = moduleService.findByIUd(moduleId);   
    ...
    public ResponseEntity<Object> getOneLesson(@PathVariable(value = "moduleId") UUID moduleId,
                                               @PathVariable(value = "lessonId") UUID lessonId) {
        Optional<LessonModel> lessonModuleOptional = lessonService.findLessonIntoModule(moduleId, lessonId);

        if (!lessonModuleOptional.isPresent()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Lesson not found for this module.");
        }

        return ResponseEntity.status(HttpStatus.OK).body(lessonModuleOptional.get());
    }
}
